...
if __name__ == '__main__':
    ...
    for code in codelist:
        for buy_rate_a_tmp in numpy.arange(0.02, 0.30, 0.03):
            for buy_rate_b_tmp in numpy.arange(0.05, 1, 0.08):
                for sell_rate_c_tmp in numpy.arange(0.02, 0.30, 0.03):
                    for sell_rate_d_tmp in numpy.arange(0.1, 1, 0.1):
                        for regular_investment_amount_tmp in range(200, 2000, 300):
                            annualized_interest_rate_tmp = process(code, buy_rate_a_tmp, buy_rate_b_tmp, sell_rate_c_tmp, sell_rate_d_tmp, regular_investment_amount_tmp)
